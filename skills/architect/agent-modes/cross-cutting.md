...
Establish: the 2–3 competing patterns currently in use (a concrete example of each); which is closest to correct, and why; what breaks or degrades when they coexist (different error shapes reaching the client, log noise, type errors, inconsistent behaviour under the same conditions).
